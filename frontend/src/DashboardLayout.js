...
const SECTIONS_BY_ROLE = {
  ADMIN: [
    ...
    { key: 'ai-features', label: '🤖 AI FEATURES', component: <AIFeatures /> },
  ],
  ORG_MANAGER: [
  ...
  GUARD: [
    ...
    { key: 'real-time-logs', label: 'REAL-TIME LOGS', component: <RealTimeVehicleLogs /> },
    { key: 'ai-features', label: '🤖 AI SCANNER', component: <AIFeatures /> },
  ],
  DRIVER: [
    { key: 'dashboard', label: 'DASHBOARD', component: <DriverDashboard /> },
    { key: 'ai-features', label: '👤 FACE CHECK-IN', component: <AIFeatures /> },
  ],
};
