// frontend/src/components/Homepage.js - FIXED VERSION
...
const Homepage = ({ onLogin }) => {
  ...
  // Handle login - directly call onLogin instead of navigating to login page
  const handleLogin = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Close modal and call parent login handler
        setShowLoginModal(false);
        onLogin(data); // Pass the login data to parent
